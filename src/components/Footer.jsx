    ...
    <footer className="bg-white border-t border-gray-200" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="border-t border-gray-100 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col items-center justify-center space-y-3 sm:flex-row sm:space-y-0 sm:space-x-6 text-xs sm:text-sm text-gray-500">
            <div className="flex items-center space-x-1.5 bg-white px-3 sm:px-4 py-2 rounded-full border border-gray-100 shadow-sm">
